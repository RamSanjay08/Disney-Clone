  ...
  return (
    <div className='flex gap-2 md:gap-5 p-2 px:5 md:px-16'>
      {ProductionHouseList.map(({id,image,video}) => (
        <div key={id} className='border-[2px] border-gray-600 rounded-lg hover:scale-110 duration-300 transition-all ease-in-out cursor-pointer shadow-xl shadow-gray-800'>
